...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'box' => [
            'driver' => 'mysql',
            'host' => env('BOX_DB_HOST', '127.0.0.1'),
            'port' => env('BOX_DB_PORT', '3306'),
            'database' => env('BOX_DB_DATABASE', 'forge'),
            'username' => env('BOX_DB_USERNAME', 'forge'),
            'password' => env('BOX_DB_PASSWORD', ''),
            'unix_socket' => env('BOX_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
