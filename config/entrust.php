...
return [
    /*
      ...
      |
     */
    'role' => \App\Modules\Role\Models\Entities\Role::class,
    /*
      |--------------------------------------------------------------------------
      | Entrust Roles Table
      |--------------------------------------------------------------------------
      ...
      |
     */
    'roles_table' => \App\Modules\Role\Models\Entities\Role::$tableAlias,
    /*
      |--------------------------------------------------------------------------
    ...
    /*
      ...
      |
     */
    'user' => \App\Modules\User\Models\Entities\User::class,
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'users_table' => \App\Modules\User\Models\Entities\User::$tableAlias,
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'role_user_table' => 'hnw_user_role_relation',
    /*
      |--------------------------------------------------------------------------
    ...
    /*
      ...
      |
     */
    'permission' => App\Modules\Permission\Models\Entities\Permission::class,
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'permissions_table' => App\Modules\Permission\Models\Entities\Permission::$tableAlias,
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'permission_role_table' => App\Modules\Permission\Models\Entities\RolePermission::$tableAlias,
    /*
      |--------------------------------------------------------------------------
