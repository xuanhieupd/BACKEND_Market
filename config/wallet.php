...
return [
     ...
     */
    'transaction' => [
        'table' => 'hnw_pay_transaction',
        'model' => App\Modules\Wallet\Models\Entities\Transaction::class,
        'casts' => [
            'amount' => 'string',
        ],
    ],
     ...
     */
    'transfer' => [
        'table' => 'hnw_pay_transfer',
        'model' => App\Modules\Wallet\Models\Entities\Transfer::class,
        'casts' => [
            'fee' => 'string',
        ],
    ],
     ...
     */
    'wallet' => [
        'table' => 'hnw_pay_wallet',
        'model' => \App\Modules\Wallet\Models\Entities\Wallet::class,
        'casts' => [
            'balance' => 'string',
        ],
        'default' => [
